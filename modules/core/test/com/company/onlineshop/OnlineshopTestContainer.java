...
public class OnlineshopTestContainer extends TestContainer {

    public OnlineshopTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/onlineshop/app.properties",
    ...
    public static class Common extends OnlineshopTestContainer {

        public static final OnlineshopTestContainer.Common INSTANCE = new OnlineshopTestContainer.Common();
